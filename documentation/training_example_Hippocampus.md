...
1) Install nnU-Net by following the instructions [here](../readme_nnUNet.md#installation). Make sure to set all relevant paths, 
...
network training - pretrained models for the hippocampus task are available (see [here](../readme_nnUNet.md#run-inference)).
