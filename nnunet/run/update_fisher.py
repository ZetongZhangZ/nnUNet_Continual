...
def main():
    ...
    print('------------------------------------')
    print('\n')
    print(f'Start updating fisher information {task}...')
    print('\n')
    print('------------------------------------')
    try:
    ...
    trainer.update_fisher_dict(trainer.tr_gen)
    trainer.print_to_log_file(trainer.fisher_dict)
    trainer.save_checkpoint(join(trainer.output_folder,"model_best_temp.model"),True)
